...
enum class SensorType { VELODYNE, OUSTER, MULRAN };
...
public:
    ...
    int N_SCAN;
    int Horizon_SCAN;
    float Angle_Resolution_X;
    float Angle_Resolution_Y;
    float Angle_Bottom_Z;
    ...
    ParamServer()
    {
        ...
        nh.param<float>("VGICP_SAM/Angle_Resolution_X", Angle_Resolution_X, 0.2);
        nh.param<float>("VGICP_SAM/Angle_Resolution_Y", Angle_Resolution_Y, 2.0);
        nh.param<float>("VGICP_SAM/Angle_Bottom_Z", Angle_Bottom_Z, 15.1);
        ...
        nh.param<int>("VGICP_SAM/useCloudRing", useCloudRing, 1);

        nh.param<double>("VGICP_SAM/IMU_HZ", IMU_HZ, 400);
        ...
        nh.param<float>("VGICP_SAM/headingDeclination", headingDeclination, 0.2);
        ...
        // nh.param<int>("/PHAROS_AGV/SENSOR_CONFIG/LiDAR/MULTI_LIDAR", MULTI_LIDAR, 0);
        nh.param<int>("/PHAROS_AGV/SENSOR_CONFIG/LiDAR/ONLINE_CALIBRATION", ONLINE_CALIBRATION, 0);
